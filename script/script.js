...
function paginationControl(type) {
	...
	paginationWrapper.innerHTML = `
        ${
			pageCounter <= 1
				? `<span class="page_number disable" id="page_left" ></span>`
				: `<span onclick="paginationControl('back')" class="page_number" id="page_left">&larr;</span>`
		}
        ${
			pageCounter <= 1
				? `<span class="page_number disable"></span>`
    ...
    `;
	console.log(
		'TCL: paginationControl -> pageCounter == totalPages',
		pageCounter,
		totalPages,
	);
